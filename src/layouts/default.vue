...
<template>
  <div class="flex h-full bg-white dark:bg-neutral-900">
    <!-- 사이드바 토글 버튼 + 새 채팅 버튼 -->
    <div
      class="absolute flex px-2 py-2.5 z-20 items-center transition-[left] duration-300 text-neutral-500 dark:text-neutral-400"
    ...
    >
      <div @dblclick="handleDoubleClick" class="flex-none h-12 w-full drag-region"></div>
    ...
    >
      <div class="h-12 flex-none w-full z-10 flex items-center drag-region" @dblclick="handleDoubleClick"></div>
